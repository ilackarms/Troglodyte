...
class CharacterMotorMovement {
	//speed change based on char stat
var movementSpeedAdjust : float = 1.0;
...
private function ApplyInputVelocityChange (velocity : Vector3) {	
	...
	var maxVelocityChange : float = GetMaxAcceleration(grounded) * Time.deltaTime * movement.movementSpeedAdjust;
...
private function GetDesiredHorizontalVelocity () {
	...
	return tr.TransformDirection(desiredLocalDirection * maxSpeed)* movement.movementSpeedAdjust;
}
